...
|:--|:--|
|Motivatie:| Er is er gekozen om enkel op werkelijk vermogen te gaan sturen. De discussie rondom blindvermogen is nog niet afgerond. Indien de noodzaak voor het sturen op blindvermogen wordt aan getoond kan dit worden toegevoegd aan de volgende versie van deze interface specificatie.|
