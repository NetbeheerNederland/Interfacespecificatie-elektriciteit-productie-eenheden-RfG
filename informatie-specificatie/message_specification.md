# 5.3 61850 profile \(BAP\)

## 61850 profile <a id="message-specification"></a>
...
![Actor overview](../.gitbook/assets/61850Actors-overview.png)

## Use Case

![use case overview](../.gitbook/assets/61850Monitor-and-control-DER.png)

## Sequence diagram

![sequence](../.gitbook/assets/61850Sequence-diagram-typical-interactions.png)

## Logical Architecture

Logical architecture monitoring function ![Logical architecture monitoring function](../.gitbook/assets/Logical_Architecture_DERmonitoringfunction.png)

Logical architecture control function ![Logical architecture control function](../.gitbook/assets/Logical_Architecture_DERcontrolfunction.png)
...
**FSCH for Schedule function** Number of schedules is limited by memory size and the way of consuming the schdules \(number of values in a schedule\).
...
**MMXU for DER monitor function** This logical node measures the actual output of the electricity production unit.
...
**keepalive** According 61850-8-2, XEP 0199 can be used to build a keep alive signal.

**XMPP** IEC 61850-8-2 should be used for communication: Communication networks and systems for power utility automation - Part 8-2: Specific communication service mapping \(SCSM\) - Mapping to Extensible Messaging Presence Protocol \(XMPP\).

**Persistence** The following items need to be persistance on the device \(saved when the device has no power\):
